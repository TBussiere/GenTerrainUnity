...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=montBlanc&box=6.507629,45.067611,6.126056,44.798117
...
-----------
  ...
  * montBlanc Height Map (ASTER 30m).png
  ...
  * montBlanc Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * montBlanc Height Map (SRTM30 Plus).png
...
These heightmaps were adjusted such that 929m (actual) is equal to 40m in
