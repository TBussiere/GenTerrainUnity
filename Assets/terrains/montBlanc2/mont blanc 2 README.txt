...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=mont+blanc+2&box=6.962078,45.896822,6.858817,45.824956
...
-----------
  ...
  * mont blanc 2 Height Map (ASTER 30m).png
  ...
  * mont blanc 2 Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * mont blanc 2 Height Map (SRTM3 v4.1).png
  ...
  * mont blanc 2 Height Map (SRTM30 Plus).png
...
These heightmaps were adjusted such that 1419m (actual) is equal to 40m in
